  ...
  return loading ? (
    ...
    <NavigationContainer>
      ...
      <Stack.Navigator initialRouteName="home">
        ...
        <Stack.Screen
          name="viewAllFlowers"
          component={viewAllFlowers}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="flowerInYourArea"
          component={FlowerInYourArea}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="nurseryInYourArea"
          component={NurseryInYourArea}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="yourFuturePlans"
          component={YourFuturePlans}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="camera"
